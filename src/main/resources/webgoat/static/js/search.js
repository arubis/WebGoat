...
function search(arg) {
      ...
      if (elementId != null) {
        ...
        // Use CSS.escape to prevent selector injection attacks
        var escapedCategoryId = CSS.escape(categoryId);
        document.querySelectorAll('[category="'+escapedCategoryId+'"]')[0].click();
      }
